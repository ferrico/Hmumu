...
#  DY SAMPLE FOR bdt TRAINING ---> LO
 #### per training####
# ./plot /afs/cern.ch/work/g/gimandor/public/Hmumu_nTuples/DYJetsToLL_M-105To160-madgraphMLM_v25_reskim.root DYJetsToLL_M mu  0 0 $QCDcorrection 0 $JEScorrection  v25 reskim histoFileDir;
 #### per training####
